			...
			<div class="jumbotron">
				<div class="row">
					<div class="col-lg-5">
						...
						<p class="">
							<a class="btn btn-primary" href="${pageContext.request.contextPath}/vistas/cuenta/login.jsp">Inciar
								sesi&oacute;n</a> <a class="btn btn-primary"
								href="${pageContext.request.contextPath}/vistas/cuenta/registrarse.jsp">Registrarse</a>
						</p>
					</div>
