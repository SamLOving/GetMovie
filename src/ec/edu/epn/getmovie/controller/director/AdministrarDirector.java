...
/**
 * Servlet implementation class AdministrarDirector
 */
@WebServlet("/director/administrar")
public class AdministrarDirector extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdministrarDirector() {
        super();
